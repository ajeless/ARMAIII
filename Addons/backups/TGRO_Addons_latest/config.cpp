...
class CfgFunctions 
{
    class TGRO 
    {
        class TGRO_Modules {
            ...
            class moduleRandomCarnageArea {
                description = "Drops wreckage, dead-bodies, creates fires, in an area";
            };
        };
    };
};
...
class CfgVehicles
{
    ...
    class TGRO_ModuleRandomCarnageArea: Module_F
    {
        scope = 2;
        displayName = "Random Carnage in Area"; 
        category = "TGRO_Modules";
        function = "TGRO_fnc_moduleRandomCarnageArea";
        functionPriority = 1;
        isGlobal = 0;
        isTriggerActivated = 1;
		isDisposable = 1;
        ...
        class Attributes: AttributesBase
        {
            class Units: Units
            {
                property = "TGRO_ModuleRandomCarnageArea_Units";
            };

            class Marker: Edit
            {
                property = "TGRO_ModuleRandomCarnageArea_Marker";
                displayName = "Marker";
                tooltip = "Marker area in which to place wrecks, drop bodies, vehicles place fires";
                typeName = "STRING";
                defaultValue = nil;
            };
            ...
            class Radius: Edit
            {
                property = "TGRO_ModuleRandomArtilleryOnArea_Radius";
                displayName = "Radius(m)";
                tooltip = "If no marker names are given, carnage will be generated in a radius around the modules placement position.";
                typeName = "NUMBER";
                defaultValue = 200;
            };
            ...
            class Wrecks: Edit 
            {
                property = "TGRO_ModuleRandomCarnageArea_Wrecks";
                displayName = "Wrecks";
                tooltip = "Reads vehicles placed in editor and creates wreckage based on those vehicle types";
                typeName = "NUMBER";
                defaultValue = 0;
            };
            ...
            class Corpses: Edit 
            {
                property = "TGRO_ModuleRandomCarnageArea_Corpses";
                displayName = "Corpses";
                tooltip = "Reads units placed in editor and creates corpses/bodies based on those unit types";
                typeName = "NUMBER";
                defaultValue = 0;
            };
            ...
            class Fires: Edit
            {
                property = "TGRO_ModuleRandomArtilleryOnArea_Fires";
                displayName = "% Fires";
                tooltip = "Chance that a a wreck or corpse is in flames (0 - 1).  EG: .25 means 25% chance of fire";
                typeName = "NUMBER";
                defaultValue = 0;
            };
        ...
        class ModuleDescription: ModuleDescription
		{
			description[] = 
            {
                "Generate a field of carnage and wreckage for effect."
            }; // Short description, will be formatted as structured text
			sync[] = {"LocationArea_F"}; // Array of synced entities (can contain base classes)
            duplicate = 1; // Multiple entities of this type can be synced
            position = 1;
