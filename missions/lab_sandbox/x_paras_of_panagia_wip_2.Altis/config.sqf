...
CarnageField = "CARNAGE_FIELD";

FriendFoeRatioInPanagia = 0;

InsertWestHasCapturedPanagia = false;
InsertWestCaptureRatio = .85; 

PanagiaVZones = ["PANAGIA_V_ZONE_1", "PANAGIA_V_ZONE_2", "PANAGIA_V_ZONE_3"];
HQSetup = 0;

ShellPanagia = false;
RandomArtilleryOrdnance = "Bo_Mk82";
RandomArtilleryDelayRange = [2, 4, 6];
RandomArtilleryBarageCount = 100;
...
// Carnage params
// min, avg, max number of wrecks
RandWreckCounts = [5, 10, 15];
